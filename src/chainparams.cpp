...
{
    const char* pszTimestamp = "Christmas Time 15/Dez/2017";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1513368426, 2084524493, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x12a765e31ffd4059bada1e25190f6e98c99d9714d334efa41a195a7e7e04bfe2"));
        assert(genesis.hashMerkleRoot == uint256S("0x97ddfbbae6be97fd6cdf3e7ca13232a3afff2353e29badfab7f73011edd4ced9"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.emplace_back("seed-a.nxtcoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.nxtcointools.com", true);
        vSeeds.emplace_back("dnsseed.nxtcoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1513368426, 293345, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        vSeeds.emplace_back("testnet-seed.nxtcointools.com", true);
        vSeeds.emplace_back("seed-b.nxtcoin.loshan.co.uk", true);
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1513368426, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
