...
const char * const BITCOIN_CONF_FILENAME = "nxtcoin.conf";
const char * const BITCOIN_PID_FILENAME = "nxtcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Nxtcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Nxtcoin";
#else
    // Unix
    return pathRet / ".nxtcoin";
#endif
#endif
}
