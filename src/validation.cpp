...
#if defined(NDEBUG)
# error "Nxtcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Nxtcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s NXT additional fees, %d delta bytes\n",
