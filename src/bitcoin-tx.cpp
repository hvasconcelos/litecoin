...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s nxtcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  nxtcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nxtcoin transaction") + "\n" +
              "  nxtcoin-tx [options] -create [commands]   " + _("Create hex-encoded nxtcoin transaction") + "\n" +
              "\n";
